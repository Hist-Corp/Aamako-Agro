...
export const SITE_PAGES: SitePage[] = [
  {
    ...
    sections: [
      ...
      { key: 'home.categories.link', label: 'View-all link', description: '“View all products” link label.', group: 'Categories grid' },
  ...
  },
  {
    ...
    badge: 'Catalogue',
    description: 'Product catalogue — every static text block is editable; products themselves come from the catalogue.',
    sections: [
      ...trustBar(),
      { key: 'page.shop.hero.eyebrow', label: 'Eyebrow', description: 'Small line above the shop headline.', group: 'Hero' },
      { key: 'page.shop.hero', label: 'Headline & sub-line', description: 'Shop headline (title) and paragraph (short).', group: 'Hero' },
      { key: 'page.shop.hero.cta1', label: 'Primary button', description: '“Shop all products” button label.', group: 'Hero' },
      { key: 'page.shop.hero.cta2', label: 'Secondary button', description: '“Browse categories” button label.', group: 'Hero' },
      { key: 'page.shop.hero.tag', label: 'Photo tag', description: '“BEST SELLER · A+ GRADE” caption on the hero photo.', group: 'Hero' },
    ],
  },
  {
    slug: 'product',
    ...
    sections: [
      { key: 'product-page.badge', label: 'Promo badge', description: 'Small badge above the title (e.g. “BEST SELLER”).', group: 'Header' },
      { key: 'product-page.title', label: 'Product title', description: 'The big product-name heading (per-product fallback).', group: 'Header' },
      { key: 'product-page.description', label: 'Short description', description: 'Intro paragraph under the title.', group: 'Header' },
      { key: 'product-page.price', label: 'Price line', description: 'Price shown in the buy box.', group: 'Buy box' },
      { key: 'product-page.pack', label: 'Pack size', description: 'Pack/format chip (e.g. “30 g pouch”).', group: 'Buy box' },
      { key: 'product-page.availability', label: 'Availability', description: 'In-stock / availability line.', group: 'Buy box' },
      { key: 'product-page.shelf-life', label: 'Shelf life', description: 'Shelf-life chip next to the availability line.', group: 'Buy box' },
      { key: 'product-page.ingredients', label: 'Ingredients', description: 'Accordion content — rich text (edit it in the “Section title” field).', group: 'Accordions' },
      { key: 'product-page.nutrition', label: 'Nutrition', description: 'Accordion content — nutrition table (rich text).', group: 'Accordions' },
      { key: 'product-page.origin', label: 'Origin', description: 'Accordion content — sourcing note incl. story link (rich text).', group: 'Accordions' },
      { key: 'product-page.storage', label: 'Storage', description: 'Accordion content — storage instructions (rich text).', group: 'Accordions' },
      { key: 'product-page.rehydrate', label: 'Rehydration steps', description: 'Accordion content — the numbered “how to rehydrate” steps (rich text).', group: 'Accordions' },
    ],
  },
  {
    slug: 'why-we-freeze',
